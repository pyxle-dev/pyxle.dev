...
const NAV_STRUCTURE = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: "guides/third-party-packages.md", slug: "third-party-packages" },
      ...
      { file: "guides/fully-typed-pyxle.md", slug: "fully-typed-pyxle" },
...
const SEARCH_KEYWORDS = {
  ...
  "guides/fully-typed-pyxle": ["typescript", "typed", "types", "type safety", "tsx", "roadmap", "type forwarding", "pydantic types", "end-to-end types", "fully typed"],
  "guides/third-party-packages": ["npm", "pip", "packages", "dependencies", "install", "shadcn", "shadcn/ui", "lucide", "import alias", "@/", "ui library", "components", "commonjs", "esm"],
